...
public class HRResDataFileReader extends DPFTFileReader {

	public HRResDataFileReader(String dir, ResFileDataLayoutDbo resFileDataLayoutDbo, String chal_name) {
	...
	public void write2TargetTable(String timestamp) throws DPFTRuntimeException {
		...
		// truncate table
		DPFTConnector connector = DPFTConnectionFactory.initDPFTConnector(DPFTUtil.getSystemDBConfig(),false);
		try {
			connector.truncate(chal_name);
			connector.close();
		} catch (SQLException e) {
			Object[] params = {chal_name};
