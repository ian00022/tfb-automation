...
public class PcbActionDataFileOutput extends DPFTActionDataFileOutput {
	@Override
	public DPFTFileFormatter getFileFormatter() throws DPFTRuntimeException {
		return new FCBFileFormatter(new DPFTFileMetaData(meta), new DPFTFileMetaData(meta, dicSet), "PCB_INFO");
	}
