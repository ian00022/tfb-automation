...
public class MBNResDataFileReader extends DPFTFileReader {

	public MBNResDataFileReader(String dir, ResFileDataLayoutDbo resFileDataLayoutDbo, String chal_name) {
	...
	public void write2TargetTable(String timestamp) throws DPFTRuntimeException {
		...
		DPFTDboSet keySet = (DPFTDboSet) DPFTConnectionFactory.initDPFTConnector(DPFTUtil.getSystemDBConfig()).getDboSet("RSP_MAIN_MBN_TEMP");
		keySet.load();
