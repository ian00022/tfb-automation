...
public class EbnActionDataTableWatch extends DPFTActionTableWatch {
	...
	public void postAction() throws DPFTRuntimeException {
		...
		/*Get Data set from "D_EBN"*/
		DPFTDboSet dEbnSet = this.getDataSet();
		
		/*Set Query criteria for "O_EBN"*/
		String qString = DPFTUtil.getFKQueryString(dEbnSet.getDbo(0));
		if(qString == null){
		...
		/*Get Data set from "O_EBN"*/
		DPFTOutboundDboSet oEbnSet = (DPFTOutboundDboSet) this.getDBConnector().getDboSet("O_EBN", qString);
		if(oEbnSet.count() > 0){
